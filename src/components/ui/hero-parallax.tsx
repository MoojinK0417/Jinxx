  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className=""
      >
        <motion.div className="flex flex-row-reverse space-x-reverse md:space-x-20 space-x-4 mb-10 overflow-x-auto scrollbar-hide">
        ...
        <motion.div className="flex flex-row space-x-4 md:space-x-20 overflow-x-auto scrollbar-hide">
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-72 w-56 md:h-96 md:w-[30rem] relative flex-shrink-0"
    >
      <Link
        href={product.link}
